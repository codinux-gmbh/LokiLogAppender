...
public interface LogLevelConfig extends QuarkusFieldConfig {

    /**
     * If the log level field should be included as Label or StructuredMetadata in Loki.
     */
    @Override
    @WithDefault(LogFieldsConfig.LogLevelDefaultIncludeValueString)
    ...
    @Override
    @WithName("fieldname")
    @WithDefault(LogFieldsConfig.LogLevelDefaultFieldName)
    String fieldName();
