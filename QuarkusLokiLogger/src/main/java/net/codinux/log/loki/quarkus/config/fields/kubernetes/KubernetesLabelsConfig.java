...
@ConfigGroup
public interface KubernetesLabelsConfig extends QuarkusPrefixFieldConfig {

    /**
     * If Kubernetes labels should be included as Label or StructuredMetadata in Loki.
     */
    @Override
    @WithDefault(KubernetesFieldsConfig.LabelsDefaultIncludeValueString)
     ...
     */
    @Override
    @WithDefault(KubernetesFieldsConfig.LabelsDefaultPrefixValue)
